					...
					<div class="middle-footer links">
						<div  class="container">
                            ...
                            <div class="col-md-4">
                                ...
                                <ul>
                                    <li><a target="_blanc" href="https://business.facebook.com/tousrenovpro/?business_id=709521832547428" title="Like Us"><span class="fa fa-facebook"></span></a></li>
                                    ...
                                    <li><a target="_blanc" href="https://www.linkedin.com/profile/preview?locale=fr_FR&trk=prof-0-sb-preview-primary-button" title="Follow Me on Twitter"><span class="fa fa-linkedin"></span></a></li>
                            ...
                            <div class="col-md-2">
                                ...
                                <h3>Liens de site</h3>
                                <ul>
                                    <li><a href="index.php"><i class="fa fa-link"></i>Accueil</a></li>
					...
					<div class="rights">
						<div class="container">
							<div class="row">
									...
									<div class="col-md-4 col-xs-12">
										<div class="row">
										<div class="designed-by">Passionnément conçu par <a href="http://weinnovat.com/">Weinnovate</a></div>
										</div>
									</div>

									<div class="col-md-4 col-xs-12 link">
										<div class="row">
											<ul>
...
$("#owl-demo").owlCarousel({
 	 ...
 	 <script src="js/responsive-nav.js"></script>
        ...
        <script src="js/form-js/jquery.backstretch.min.js"></script>
        <script src="js/form-js/retina-1.1.0.min.js"></script>
        <script src="js/form-js/scripts.js"></script>
