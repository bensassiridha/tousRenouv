							...
							<div class="row">
								...
								<div class="header-page">
									...
									<div class="bttn-devis">
										<ul>
											<li><a href="devis.php"><i>CrÃ©er votre devis</i></a></li>
											<li><a href="prix-travaux.php"><i>Devis ImmÃ©diat</i></a></li>
										</ul>
									</div>
								</div>
								</div>
							...
							<div class="container">
								...
								<div class="col-md-12">
									<div class="">
										...
										echo '<p id="affi" ><strong><br />Espace affilié :</strong></p><br />'.$req['description'];
										?>
									</div>
