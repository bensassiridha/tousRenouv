...
$lang = array_merge($lang, array(
	...
	'BBCODE_DANGER'				=> 'Olet lisäämässä BBCodea, joka sisältää {TEXT} arvon HTML sisällä. Tämä voi johtaa XSS haavoittuvuuteen sivustollasi ja on suositeltavaa käyttää rajoitettuja {SIMPLETEXT}tai {INTTEXT} arvoja. Jatka eteenpäin vain jos hyväksyt riskin ja {TEXT} arvon korvaaminen toisella ei ole mahdollista.',
	...
	'TOKEN'					=> 'Merkki',
	'TOKENS'				=> 'Merkit',
	'TOKENS_EXPLAIN'		=> 'Merkit ottavat vastaan käyttäjän suorittaman toiminnon. Toiminto hyväksytään vain mikäli se vastaa määrittely. Jos haluat, voit numeroida ne lisäämällä arvon sulkuihin, e.g. {TEXT1}, {TEXT2}.<br /><br />Voit myös käyttää asennettujen kielitiedostojen muuttujia language/-hakemistosta. Esimerkillä: {L_<em>&lt;STRINGNAME&gt;</em>} missä <em>&lt;STRINGNAME&gt;</em> on käännetyn tekstin merkkijono. Esimerkiksi, {L_WROTE} Näytetään "Kirjoitti" tai sillä kielellä, joka käyttäjän profiilissa<br /><br /><strong>Huomaa, että mukautetun BBCoden kanssa voi käyttää vain alapuolella lueteltuja merkkejä.</strong>',
	...
	'tokens'	=>	array(
		'TEXT'			=> 'Mikä tahansa teksti mukaanluettuna ulkomaalaiset kirjoitusmerkit, numerot, jne. Huomaa, että tämän käyttö HTML-tagien sisällä ei ole suositeltavaa ja se saattaa johtaa tietoturvaongelmiin. Käytä {IDENTIFIER} tai {SIMPLETEXT} -muotoja siellä missä {TEXT} -muotoa ei välttämättä tarvita.',
...
// Disallow Usernames
$lang = array_merge($lang, array(
	'ACP_DISALLOW_EXPLAIN'	=> 'Täällä voit määritellä käyttäjätunnuksia, joiden käyttö ei ole sallittu. Kielletyissä nimimerkeissä voi käyttää myös erikoismerkkiä *.',
