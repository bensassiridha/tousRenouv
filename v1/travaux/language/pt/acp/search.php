...
$lang = array_merge($lang, array(
	...
	'FULLTEXT_MYSQL_MBSTRING'				=> 'Suporte para non-latin UTF-8 carateres utilizando mbstring:',
	'FULLTEXT_MYSQL_PCRE'					=> 'Suporte para non-latin UTF-8 carateres utilizando PCRE:',
	'FULLTEXT_MYSQL_MBSTRING_EXPLAIN'		=> 'Se o PCRE não tiver propriedades de carater unicode, o sistema de pesquisa tentará utilizar o sistema de expressões regulares mbstring.',
	'FULLTEXT_MYSQL_PCRE_EXPLAIN'			=> 'Esta pesquisa exige propriedades de carater PCRE, que somente estão presentes nas versões superiores a PHP 4.4, 5.1, se quer procurar non-latin caráter.',
    'FULLTEXT_MYSQL_MIN_SEARCH_CHARS_EXPLAIN'   => 'Número mínimo de carateres das palavras que são indexados para pesquisa. A alteração desta configuração tem de ser feita no mysql por si ou pelo administrador do servidor.',
    'FULLTEXT_MYSQL_MAX_SEARCH_CHARS_EXPLAIN'   => 'Número máximo de carateres das palavras que são indexados para pesquisa. A alteração desta configuração tem de ser feita no mysql por si ou pelo administrador do servidor.',
	...
	'LIMIT_SEARCH_LOAD_EXPLAIN'				=> 'Se a carga do sistema de 1 minuto exceder este valor, a página de pesquisa irá ficar offline, 1.0 igual ~100% utilização de um processador. Isto apenas funciona em Servidores UNIX.',

	'MAX_SEARCH_CHARS'						=> 'Núm. Máximo de Carateres indexandos por pesquisa',
	'MAX_SEARCH_CHARS_EXPLAIN'				=> 'Palavras com não mais que estes pequenos carateres serão indexandos para pesquisa.',
	...
	'MIN_SEARCH_CHARS'						=> 'Núm. Mín. de Carateres indexandos por pesquisa',
	'MIN_SEARCH_CHARS_EXPLAIN'				=> 'Palavras com menos que estes pequenos carateres serão indexandos para pesquisa.',
	'MIN_SEARCH_AUTHOR_CHARS'				=> 'Núm. Mínimo de Carateres do Nome do Autor',
	'MIN_SEARCH_AUTHOR_CHARS_EXPLAIN'		=> 'Os Utilizadores terão que escrever mais do que estes carateres do Nome enquanto executando uma pesquisa por autor. Se o Nome do Autor for menos que este número ainda pode pesquisar pelas mensagens do autor, escrevendo o nome de utilizador completo.',
	...
	'SEARCH_INDEX_CREATED'					=> 'Todas as Mensagens foram indexandas na Base de Dados com sucesso.',
	...
	'TOTAL_WORDS'							=> 'Número Total de Palavras indexandas',
	'TOTAL_MATCHES'							=> 'Número Total de Palavras indexandas para relações de Mensagens',
