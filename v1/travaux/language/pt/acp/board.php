...
$lang = array_merge($lang, array(
	...
	'DISABLE_BOARD_EXPLAIN'			=> 'O Fórum fica inacessível aos Utilizadores. Pode justificar o fecho temporário introduzindo uma Mensagem até 255 carateres',
...
$lang = array_merge($lang, array( 
	...
	'ALLOW_QUICK_REPLY_EXPLAIN'		=> 'Este interruptor permite ativar/desativar globalmente a <b>Resposta Rápida</b> em todo o Fórum. Quando ativado, terá ainda que ativar a <b>Resposta Rápida</b> individualmente em cada um dos Fóruns.',
...
$lang = array_merge($lang, array( 
	...
	'AVATAR_GALLERY_PATH_EXPLAIN'	=> 'Diretoria dependendo da raiz do phpBB para Galeria de Avatares: Exemplo: <b>\images\avatars\gallery</b>.',
...
$lang = array_merge($lang, array( 	
	...
	'ALLOW_POST_LINKS_EXPLAIN'		=> 'Se desativado, a Tag BBCode <b>[URL]</b> e as URLs mágicas serão desativadas nas Mensagens Privadas.',
	'ALLOW_POST_FLASH'				=> 'Permitir o uso da Tag BBCode <b>[FLASH]</b> nas Mensagens',
	'ALLOW_POST_FLASH_EXPLAIN'		=> 'Se desativado, a Tag BBCode <b>[FLASH]</b> ficará inativa nas Mensagens em geral. De qualquer forma, o Sistema de Permissões pode ajudar a controlar as TAGs que Utilizadores podem usar.',
	...
	'CHAR_LIMIT'					=> 'Máximo de carateres por Mensagem',
	'CHAR_LIMIT_EXPLAIN'			=> 'Número máximo de carateres da mensagem. 0 = Ilimitados.',
	'DELETE_TIME'					=> 'Tempo limite para apagar',
	'DELETE_TIME_EXPLAIN'			=> 'Limita o tempo disponível para eliminar uma nova mensagem. Definir o valor como 0 desativa esta função.',
	...
	'FLOOD_INTERVAL'				=> 'Intervalo de Fluxo',
	...
	'MIN_CHAR_LIMIT'				=> 'Mínimo de carateres por Mensagem',
	'MIN_CHAR_LIMIT_EXPLAIN'		=> 'O número mínimo de carateres que o Utilizador tem de usar numa Mensagem.',
	'POSTING'						=> 'Postando',
...
$lang = array_merge($lang, array( 
	...
	'MAX_SIG_LENGTH_EXPLAIN'			=> 'Número Máximo de carateres na Assinatura do Utilizador.',
...
//	'ACC_USER_ADMIN'					=> 'User + Admin',
	...
	'PASSWORD_LENGTH_EXPLAIN'			=> 'Número Mínimo e Máximo de carateres das Senhas.',
	...
	'USERNAME_CHARS'					=> 'Limite de carateres para o nome do Utilizador',
	'USERNAME_CHARS_ANY'				=> 'Qualquer carater',
	'USERNAME_CHARS_EXPLAIN'			=> 'Tipo restrito de carateres aceites no nome do Utilizador; espaço, -, +, _, [ e ].',
	'USERNAME_LENGTH'					=> 'Tamanho do nome do Utilizador',
	'USERNAME_LENGTH_EXPLAIN'			=> 'Número Mínimo e Máximo de carateres nos nomes dos Utilizadors.',
)); 
...
$lang = array_merge($lang, array( 
	...
	'COOKIE_SECURE_EXPLAIN'					=> 'Se o Servidor funciona por SSL, mude para <b>Ativado</b> caso contrário, deixe-o <b>Desativado</b>. Estando <b>Ativado</b> sem funcionar por SSL poderá resultar em erros no Servidor durante os redirecionamentos.',
...
// Auth settings 
$lang = array_merge($lang, array( 
	'ACP_AUTH_SETTINGS_EXPLAIN'				=> 'O phpBB suporta Plug-ins ou Módulos que permitem definir o método de autenticação dos Utilizadores que entram no Fórum. <br />São disponibilizados três plugins: DB, LDAP e Apache. Nem todos os Módulos necessitam de informação adicional. Preencha apenas os campos relevantes para o método selecionado.',
...
$lang = array_merge($lang, array( 
	...
	'FORCE_SERVER_VARS_EXPLAIN'				=> 'Se selecionar <b>Sim</b> serão usadas as configurações aqui definidas em alternativa aos valores definidos automaticamente.',
	'ICONS_PATH'							=> 'Diretoria para Ficheiro de Ícones',
	'ICONS_PATH_EXPLAIN'					=> 'Diretoria sob o diretoria raiz do phpBB. Exemplo: <b>images/ícons</b>.',
	'PATH_SETTINGS'							=> 'Configurações de Pastas',
	'RANKS_PATH'							=> 'Diretoria para Ficheiro de Imagens de Rank',
	'RANKS_PATH_EXPLAIN'					=> 'Diretoria sob a diretoria raiz do phpBB. Exemplo: <b> images/ranks.</b>',
	'SCRIPT_PATH'							=> 'Diretoria do script',
	'SCRIPT_PATH_EXPLAIN'					=> 'Diretoria onde o phpBB está instalado com relação ao Domínio. Exemplo: <b>phpBB3</b>.',
	...
	'SMILIES_PATH_EXPLAIN'					=> 'Diretoria sob a diretoria raiz do phpBB. Exemplo: <b>images/smilies</b>.',
	'UPLOAD_ICONS_PATH'						=> 'Diretoria de Ficheiro de Ícones de Grupos de Extensões',
	'UPLOAD_ICONS_PATH_EXPLAIN'				=> 'Diretoria sob a diretoria raiz do phpBB. Exemplo: <b>images/upload_icons</b>.',
)); 
...
$lang = array_merge($lang, array( 
	...
	'AUTOLOGIN_LENGTH_EXPLAIN'				=> 'Duração das chaves de acesso automático, <strong>0 para desativar</strong>.',
	...
	'FORCE_PASS_CHANGE_EXPLAIN'				=> 'Duração em dias da Senha de acesso ao Fórum. Após este prazo é pedido ao Utilizador que altere a sua Senha. <strong>0 para desativar</strong>.',
	...
	'IP_VALID_EXPLAIN'						=> 'Determina como é autenticado o IP do Utilizador. <b>Todos</b> compara o endereço completo. <b>A.B.C</b> os primeiros x.x.x. <b>A.B</b> os primeiros x.x. <b>Nenhum</b> desativa a verificação. Em endereços IPv6: <b>A.B.C</b> compara os primeiros quatro blocos. <b>A.B</b> os primeiros 3 blocos.',
...
$lang = array_merge($lang, array( 
	...
	'ADMIN_EMAIL_EXPLAIN'					=> 'Será utilizado como endereço de resposta em todas as Mensagens. Este é o email padrão do Fórum para contato e envio de emails pelo sistema phpBB.',
	...
	'CONTACT_EMAIL'							=> 'Endereço email de Contato',
	'CONTACT_EMAIL_EXPLAIN'					=> 'Este endereço será usado sempre que é necessário um contato específico, (spam, erro de saída, etc). Pode ser sempre utilizado como endereço para envio e respostas nos emails.',
