<?php
	...
	class mysql
	{
		function mysql()
		{
			...
			$this->db = 'liwebageweb';
		   $this->connexion = mysql_connect("mysql51-78.bdb","liwebageweb","lilikiki2013");
			//$this->db = 'tvmondebol82';
		   //$this->connexion = mysql_connect("mysql5-28.perso","tvmondebol82","badri19bol82");
