...
/*		array (
	...
	$cfg['ilibs_dir'] 	   = array('/admin/bibliotheque/');						   	// image library path with slashes; absolute from root directory  e.g. '/pictures/' - please make sure that the directories have write permissions
