	...
	switch ( $_GET['contenu'] )
	{
		case 'inscription' :
			...
			echo'
				...
				<div id="espace_compte" style="margin: 0 0 0 100px;">
					<form name="client_ajout" action="espace_particulier.php?contenu=inscription" method="post" enctype="multipart/form-data" class="tpl_form_defaut intitules_moyens champs_larges">
					<fieldset>
				...
				switch ( $_GET['action'] )
				{
					case 'ajouter' :
						...
						echo'
							'.$alert.'
							<div id="espace_compte" style="margin: 0 0 0 100px;">
								<form name="adresse" action="espace_particulier.php?contenu=adresse&action=ajouter" method="post" enctype="multipart/form-data" class="tpl_form_defaut intitules_moyens champs_larges">
								<fieldset>
									<legend>Informations personnelles</legend>
									<p>
										<label for="ip_voi">Numéro et voie : <span class="obli">*</span></label>
					...
					case 'modifier' :
						...
						echo'
							'.$alert.'
							<div id="espace_compte" style="margin: 0 0 0 100px;">
								<form name="adresse" action="espace_particulier.php?contenu=adresse&action=modifier&id='.$_GET['id'].'" method="post" enctype="multipart/form-data" class="tpl_form_defaut intitules_moyens champs_larges">
								<fieldset>
									<legend>Informations personnelles</legend>
									<p>
										<label for="ip_voi">Numéro et voie : <span class="obli">*</span></label>
		...
		case 'devis_histo' :
			if ( isset($_GET['idDevis']) )
			{
				...
				</table><a id="various3" href="imp_cheque.php?idDevis='.$_GET['idDevis'].'&suite=ok">Aperçu avant imprimer</a>';
				...
				$detail.='
						...
						<div id="espace_compte">
							...
							<form  style="margin: 10px 0 0 120px;" name="note_envoie" method="post" class="tpl_form_defaut intitules_moyens champs_larges" enctype="multipart/form-data" >
								<fieldset>
									<legend>Note :</legend>
									<p>
										<label for="val">Note / 20 : <span class="obli">*</span></label>
										<input id="val" type="text" name="val" value="'.$id['note_devis'].'" onKeyPress="return scanTouche(event)" />
									</p>
			...
			<div id="espace_compte">
				<ul id="compte_authentification">
					<li class="compte_deja_client">
						...
						<div>
							<form action="espace_particulier.php?contenu=connexion" name="client_conn" method="post" class="tpl_form_defaut intitules_moyens" >
								<p>
								...
								<p class="padding_top_5"><cite>Si vous avez oublié votre mot de passe, <a href="espace_particulier.php?contenu=mdp_perdu" style="color:#000">cliquez ici</a>.</cite></p>																
								<p>
					...
					<li class="compte_inscription">
						...
						<div >
							...
							<p><a href="espace_particulier.php?contenu=inscription" class="boutons_persos_1">Créer un compte</a></p>
						</div>
					</li>
				</ul>			
			</div>
