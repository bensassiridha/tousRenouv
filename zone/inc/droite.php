    			...
    			return false ;
								...
								<div class="extra-wrap text-1">
									...
									<form name="formnewsletter" action="#" method="post" onSubmit="return validermail(this);" >
										<input name="email" type="text" class="inp" placeholder="Recevez Nos actualit&eacute;s"/>
										<input class="button" name="EnvoiNewsletter_inscrit" type="submit" value="Inscrivez-vous à notre newsletter" />
