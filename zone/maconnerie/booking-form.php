 <?php
        ...
        if(isset($_POST['submit'])){
                ...
                $sql = "INSERT INTO demande_devis (civilite, nom, prenom, email, adresse, code_postal, ville, content, spec, batiment,
                    travaux, disponibility, until, period, nombre, phone, telephone, category_id) VALUES ('$civilite', '$nom', '$prenom', '$email',
                    '$adress', '$cp', '$ville', '$content', '$spec', '$batiment', '$trav', '$disponibility', '$until', '$delay',
                    '$num_devis', '$phone', '$telephone', '$category_id')";
