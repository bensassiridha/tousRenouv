            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="head-content">
                        <?php
                            $sql = "SELECT * FROM categories_devis WHERE category_id = 6";
                            $result = $conn->query($sql);
                        
                            if($result->num_rows > 0){
                                while($row = $result->fetch_assoc()) {
                                    echo "<h1>".$row["category"]."</h1><span class='hidden_id'>".$row["category_id"]."</span>";
                                }
                            }
                        ?>
        ...
        <section id="request" class="request-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="row">
                            <img src="images/activite-6.jpg" alt="Maçonnerie" >
                            <div class="col-md-4">
                            	<div class="avantages">
