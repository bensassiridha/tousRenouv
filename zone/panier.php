		...
		case 'paiement' :
			...
			if ( !isset($_GET['module']) )
			{
				...
				if ( $temp['statut']==1 && !empty($temp['val1']) && !empty($temp['val2']) )
				{
					$module_cheque='
									<p class="payment_module">
										<a title="Payer par Chéque" href="panier.php?contenu=paiement&module=cheque">
			...
			else
			{
				if ( $_GET['module']=='test' )
				{
					echo'
						<div id="espace_compte">
							<a href="panier.php?ref='.$reference_commande.'">Paiement effectué</a> |
							<a href="panier.php?paiement=annuler">Paiement annulé</a></p>
						</div>
						';
				}
					...
					echo'
								<div id="espace_compte" style="margin:0 0 0 80px;">
									...
									<p>Merci de nous envoyer un virement bancaire avec :
										...
										<br />- N\'oubliez pas d\'indiquer votre référence de commande <strong> "'.$reference_commande.'" </strong> dans le sujet de votre virement
					...
					echo'
								<div id="espace_compte" style="margin:0 0 0 80px;">
									...
									<p>Merci de nous envoyer un chèque :
										...
										<br />- N\'oubliez pas d\'indiquer votre référence de commande <strong> "'.$reference_commande.'" </strong> sur le chéque
										<p>Votre commande vous sera validé dès réception du paiement.</p>
										<p>Pour toute question ou information complémentaire merci de contacter notre <a href="contact.php">support client</a></p>.
									</p>
								</div>
...
elseif ( isset($_SESSION['panier_trn']) )
{
	...
	if ( isset($_GET['supprimer']) ) $alert='<div id="note" class="notice" ><p>Devis supprimé.</p></div><br />';
...
{
	if ( isset($_GET['paiement']) && $_GET['paiement']=='valider' ) $mp='<div id="note" class="success">Le paiement a été effectué avec succés.</div>';
	else if ( isset($_GET['paiement'])&& $_GET['paiement']=='annuler' )$mp='<div id="note" class="error">Le paiement a été annulée.</div>';
