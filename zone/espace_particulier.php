					...
					<div class="particulier-space">
						<div class="container">
							...
							<div class="col-md-12">
								...
								<h5>Gérer toutes vos informations personnelles ainsi que vos commandes</h5>
...
$(document).ready(function() {								
	...
	$('input[name="cp"]').change(function ()
	{
		$.ajax({
			 type: "post",
			 url: "http://tousrenov.fr/zone/AjaxVille.php",
			...
			echo'
				...
				<div class="col-md-12" >
					...
					<div class="container">
						...
						<p>
							<input type="checkbox" name="condition" id="condition"/> Acceptation des <a  href="mention.php#part" target="_blanc" title="Conditions générales"> conditions générales </a>
						</p>
			...
			'.$alert.'		
				...
				<div class="col-md-4">
					<div class="espace-box1">
						...
						<a href="espace_particulier.php?contenu=adresse">Gérer mes adresses</a>
					</div>
				</div>	
				...
				<div class="col-md-4">
					<div class="espace-box1">
						...
						<p>C\'est dans cette section que vous pourrez consulter l\'historique de vos devis avec enchère.</p>
				...
				<div class="col-md-4">
					<div class="espace-box1">
						...
						<p>C\'est dans cette section que vous pourrez valider ou arréter votre devis avec achat immédiat.</p>
