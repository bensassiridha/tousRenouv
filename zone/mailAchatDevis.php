<?php
$temppp=$my->req_arr('SELECT * FROM ttre_client_pro WHERE id='.$id_client_pro.' ');
...
$res_villec=$my->req_arr('SELECT * FROM ttre_villes_france WHERE ville_id="'.$res['ville'].'" ');
			...
			<div id="corps" style="margin:0 auto; width:800px; height:auto;">
				...
				<p>Voilà le détail de chantier :</p>
						...
						<dl>					
							...
							<dd>Ville : '.html_entity_decode($res_villec['ville_nom_reel']).'</dd>
