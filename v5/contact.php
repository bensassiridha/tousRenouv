...
<!-- <label for="ip_nom">Nom : <span class="obli">*</span></label> -->
											<div class="last-first-name">
												...
												<input id="ip_prenom" type="text" name="prenom" placeholder="Votre Prénom"/><br />
											</div>
											<div class="perso-info">
												<input id="ip_tel" type="text" name="telephone" placeholder="Téléphone"/><br />
