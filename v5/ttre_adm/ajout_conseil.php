...
$my = new mysql();
			...
			$req_ajout_cat = $my->req("	INSERT INTO ttre_conseil VALUES('','".$my->net($_POST['titre'])."','".$my->net($_POST['rep'])."')");
						if(!$req_ajout_cat)
							{
...
$tab = array();
				...
				$form = new formulaire('modele_1','?contenu=ajout_conseil','','','','sub','txt','','txt_obl','lab_obl');
						$form->text('Titre','titre','',1);
						$form->tinyMCE('Contenu','description','');
