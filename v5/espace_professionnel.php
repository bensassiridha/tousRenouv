...
if ( isset($_GET['contenu']) )
{
    ...
    <div class="product"> 				
    <div class="price">
       <td colspan="1" class="">'.$infos_devis['reference'].'</td>
    </div>';
    $detail.=' 
    <div class="price">
       <td colspan="1" class="prix_final">'.$total.' €</td>
    ...
    <input type="hidden" name="business" value="youness.elbezzazi-facilitator@gmail.com">
    <input type="hidden" name="cmd" value="_xclick">
    <input type="hidden" name="item_name" value="'.$infos_devis['reference'].'">
    ...
    <input type="hidden" name="cancel_return" value="http://tousrenov.fr/cancel.php">
    <input type="hidden" name="return" value="http://tousrenov.fr/espace_professionnel.php?contenu=devis_att_paye&idDevisPaye='.$_GET['idDevis'].'">
    <input name="notify_url" type="hidden" value="http://tousrenov.fr/ipn.php" /> 
