			...
			if ( $("#panier_6").html()=="" )
			{
				if ( $("#quest_36").val() )
				{
					if ( $("#quest_33").val()==0 )
					{
						...
						$("#panier_6").append('<tr id="trQuest_33_36"><td id="tdLabelQuest_33_36">Donner plus de précisions, en répondant aux questions pour la partie : Généralités</td><td id="tdUniteQuest_33_36"></td><td id="tdQteQuest_33_36" class="n">0.00</td><td id="tdPrixUniQuest_33_36" class="n">0.00</td><td id="tdPrixQuest_33_36" class="n">0.00</td></tr>');
					}
					else
					{
						totalHTancien=$("#totalHT").html();
			...
			if ( $("#panier_6").html()=="" )
			{
				if ( $("#quest_34").val() )
				{
					if ( $("#quest_33").val()==0 )
					{
						$("#panier_6").css('display','');
						$("#panier_6").append('<tr id="trCat_6" class="stot"><th colspan="3">Electricité</th><th>sous-total HT</th><th id="prixCateg_6" class="n">0</th></tr>');
						$("#panier_6").append('<tr id="trQuest_33_34"><td id="tdLabelQuest_33_34">Donner plus de précisions, en répondant aux questions pour la partie : Généralités</td><td id="tdUniteQuest_33_34"></td><td id="tdQteQuest_33_34" class="n">0.00</td><td id="tdPrixUniQuest_33_34" class="n">0.00</td><td id="tdPrixQuest_33_34" class="n">0.00</td></tr>');
					}
					else
					{
						totalHTancien=$("#totalHT").html();
						...
						$("#panier_6").css('display','');
						$("#panier_6").append('<tr id="trCat_6" class="stot"><th colspan="3">Electricité</th><th>sous-total HT</th><th id="prixCateg_6" class="n">'+number_format(prixCat,2,'.','')+'</th></tr>');
						$("#panier_6").append('<tr id="trQuest_33_34"><td id="tdLabelQuest_33_34">'+text+'</td><td id="tdUniteQuest_33_34">unité</td><td id="tdQteQuest_33_34" class="n">'+number_format(parseInt($("#quest_34").val()),2,'.','')+'</td><td id="tdPrixUniQuest_33_34" class="n">'+number_format(prixUnitaire,2,'.','')+'</td><td id="tdPrixQuest_33_34" class="n">'+number_format(prixQuest,2,'.','')+'</td></tr>');
					}
				}
			}
			else
			...
			if ( $("#panier_2").html()=="" )
			{
				if ( $("#quest_47").val() )
				{
					if ( $("#quest_46").val()==0 )
					{
						...
						$("#panier_2").append('<tr id="trQuest_46_47"><td id="tdLabelQuest_46_47">Donner plus de précisions, en répondant aux questions pour la partie : Généralités</td><td id="tdUniteQuest_46_47"></td><td id="tdQteQuest_46_47" class="n">0.00</td><td id="tdPrixUniQuest_46_47" class="n">0.00</td><td id="tdPrixQuest_46_47" class="n">0.00</td></tr>');
					}
					else
					{
						totalHTancien=$("#totalHT").html();
						...
						$("#panier_2").append('<tr id="trQuest_46_47"><td id="tdLabelQuest_46_47">'+text+'</td><td id="tdUniteQuest_46_47">unité</td><td id="tdQteQuest_46_47" class="n">'+number_format(parseInt($("#quest_47").val()),2,'.','')+'</td><td id="tdPrixUniQuest_46_47" class="n">'+number_format(prixUnitaire,2,'.','')+'</td><td id="tdPrixQuest_46_47" class="n">'+number_format(prixQuest,2,'.','')+'</td></tr>');
						$("#panier_2").append('<tr id="trQuest_46_47_P"><td id="tdLabelQuest_46_47_P">'+text_P+'</td><td id="tdUniteQuest_46_47_P">unité</td><td id="tdQteQuest_46_47_P" class="n">'+number_format(parseInt($("#quest_47").val()),2,'.','')+'</td><td id="tdPrixUniQuest_46_47_P" class="n">'+number_format(prixUnitaire_P,2,'.','')+'</td><td id="tdPrixQuest_46_47_P" class="n">'+number_format(prixQuest_P,2,'.','')+'</td></tr>');
					}
				}
			}
			else
			...
			if ( $("#panier_2").html()=="" )
			{
				if ( $("#quest_51").val() )
				{
					if ( $("#quest_46").val()==0 )
					{
						$("#panier_2").css('display','');
						$("#panier_2").append('<tr id="trCat_2" class="stot"><th colspan="3">Menuiserie</th><th>sous-total HT</th><th id="prixCateg_2" class="n">0</th></tr>');
						$("#panier_2").append('<tr id="trQuest_46_51"><td id="tdLabelQuest_46_51">Donner plus de précisions, en répondant aux questions pour la partie : Généralités</td><td id="tdUniteQuest_46_51"></td><td id="tdQteQuest_46_51" class="n">0.00</td><td id="tdPrixUniQuest_46_51" class="n">0.00</td><td id="tdPrixQuest_46_51" class="n">0.00</td></tr>');
					}
					else
					{
						totalHTancien=$("#totalHT").html();
						...
						$("#panier_2").css('display','');
						$("#panier_2").append('<tr id="trCat_2" class="stot"><th colspan="3">Menuiserie</th><th>sous-total HT</th><th id="prixCateg_2" class="n">'+number_format(prixCat,2,'.','')+'</th></tr>');
						$("#panier_2").append('<tr id="trQuest_46_51"><td id="tdLabelQuest_46_51">'+text+'</td><td id="tdUniteQuest_46_51">unité</td><td id="tdQteQuest_46_51" class="n">'+number_format(parseInt($("#quest_51").val()),2,'.','')+'</td><td id="tdPrixUniQuest_46_51" class="n">'+number_format(prixUnitaire,2,'.','')+'</td><td id="tdPrixQuest_46_51" class="n">'+number_format(prixQuest,2,'.','')+'</td></tr>');
						$("#panier_2").append('<tr id="trQuest_46_51_P"><td id="tdLabelQuest_46_51_P">'+text_P+'</td><td id="tdUniteQuest_46_51_P">unité</td><td id="tdQteQuest_46_51_P" class="n">'+number_format(parseInt($("#quest_51").val()),2,'.','')+'</td><td id="tdPrixUniQuest_46_51_P" class="n">'+number_format(prixUnitaire_P,2,'.','')+'</td><td id="tdPrixQuest_46_51_P" class="n">'+number_format(prixQuest_P,2,'.','')+'</td></tr>');
					}
				}
			}
			else
				...
				if ( $("#quest_51").val() )
				{
					if ( $("#quest_46").val()!=0 )
					{
						...
						else
						{
							...
							$("#totalTTC").html(number_format(totalTTC,2,'.',''));
							$("#prixCateg_2").html(number_format(prixCat,2,'.',''));
							$("#tdQteQuest_46_51").html(number_format(parseInt($("#quest_51").val()),2,'.',''));
							$("#tdPrixQuest_46_51").html(number_format(prixQuest,2,'.',''));
							$("#tdQteQuest_46_51_P").html(number_format(parseInt($("#quest_51").val()),2,'.',''));
							$("#tdPrixQuest_46_51_P").html(number_format(prixQuest_P,2,'.',''));
						}
					}
					else
			...
			if ( $("#panier_2").html()=="" )
			{
				if ( $("#quest_52").val() )
				{
					if ( $("#quest_46").val()==0 )
					{
						$("#panier_2").css('display','');
						$("#panier_2").append('<tr id="trCat_2" class="stot"><th colspan="3">Menuiserie</th><th>sous-total HT</th><th id="prixCateg_2" class="n">0</th></tr>');
						$("#panier_2").append('<tr id="trQuest_46_52"><td id="tdLabelQuest_46_52">Donner plus de précisions, en répondant aux questions pour la partie : Généralités</td><td id="tdUniteQuest_46_52"></td><td id="tdQteQuest_46_52" class="n">0.00</td><td id="tdPrixUniQuest_46_52" class="n">0.00</td><td id="tdPrixQuest_46_52" class="n">0.00</td></tr>');
					}
					else
					{
						totalHTancien=$("#totalHT").html();
						...
						$("#panier_2").css('display','');
						$("#panier_2").append('<tr id="trCat_2" class="stot"><th colspan="3">Menuiserie</th><th>sous-total HT</th><th id="prixCateg_2" class="n">'+number_format(prixCat,2,'.','')+'</th></tr>');
						$("#panier_2").append('<tr id="trQuest_46_52"><td id="tdLabelQuest_46_52">'+text+'</td><td id="tdUniteQuest_46_52">unité</td><td id="tdQteQuest_46_52" class="n">'+number_format(parseInt($("#quest_52").val()),2,'.','')+'</td><td id="tdPrixUniQuest_46_52" class="n">'+number_format(prixUnitaire,2,'.','')+'</td><td id="tdPrixQuest_46_52" class="n">'+number_format(prixQuest,2,'.','')+'</td></tr>');
						$("#panier_2").append('<tr id="trQuest_46_52_P"><td id="tdLabelQuest_46_52_P">'+text_P+'</td><td id="tdUniteQuest_46_52_P">unité</td><td id="tdQteQuest_46_52_P" class="n">'+number_format(parseInt($("#quest_52").val()),2,'.','')+'</td><td id="tdPrixUniQuest_46_52_P" class="n">'+number_format(prixUnitaire_P,2,'.','')+'</td><td id="tdPrixQuest_46_52_P" class="n">'+number_format(prixQuest_P,2,'.','')+'</td></tr>');
					}
				}
			}
			else
				...
				if ( $("#quest_52").val() )
				{
					if ( $("#quest_46").val()!=0 )
					{
						...
						else
						{
							...
							$("#totalTTC").html(number_format(totalTTC,2,'.',''));
							$("#prixCateg_2").html(number_format(prixCat,2,'.',''));
							$("#tdQteQuest_46_52").html(number_format(parseInt($("#quest_52").val()),2,'.',''));
							$("#tdPrixQuest_46_52").html(number_format(prixQuest,2,'.',''));
							$("#tdQteQuest_46_52_P").html(number_format(parseInt($("#quest_52").val()),2,'.',''));
							$("#tdPrixQuest_46_52_P").html(number_format(prixQuest_P,2,'.',''));
						}
					}
					else
			...
			if ( $("#panier_2").html()=="" )
			{
				if ( $("#quest_49").val() )
				{
					if ( $("#quest_46").val()==0 )
					{
						$("#panier_2").css('display','');
						$("#panier_2").append('<tr id="trCat_2" class="stot"><th colspan="3">Menuiserie</th><th>sous-total HT</th><th id="prixCateg_2" class="n">0</th></tr>');
						$("#panier_2").append('<tr id="trQuest_46_49"><td id="tdLabelQuest_46_49">Donner plus de précisions, en répondant aux questions pour la partie : Généralités</td><td id="tdUniteQuest_46_49"></td><td id="tdQteQuest_46_49" class="n">0.00</td><td id="tdPrixUniQuest_46_49" class="n">0.00</td><td id="tdPrixQuest_46_49" class="n">0.00</td></tr>');
					}
					else
					{
						totalHTancien=$("#totalHT").html();
						...
						$("#panier_2").css('display','');
						$("#panier_2").append('<tr id="trCat_2" class="stot"><th colspan="3">Menuiserie</th><th>sous-total HT</th><th id="prixCateg_2" class="n">'+number_format(prixCat,2,'.','')+'</th></tr>');
						$("#panier_2").append('<tr id="trQuest_46_49"><td id="tdLabelQuest_46_49">'+text+'</td><td id="tdUniteQuest_46_49">unité</td><td id="tdQteQuest_46_49" class="n">'+number_format(parseInt($("#quest_49").val()),2,'.','')+'</td><td id="tdPrixUniQuest_46_49" class="n">'+number_format(prixUnitaire,2,'.','')+'</td><td id="tdPrixQuest_46_49" class="n">'+number_format(prixQuest,2,'.','')+'</td></tr>');
						$("#panier_2").append('<tr id="trQuest_46_49_P"><td id="tdLabelQuest_46_49_P">'+text_P+'</td><td id="tdUniteQuest_46_49_P">unité</td><td id="tdQteQuest_46_49_P" class="n">'+number_format(parseInt($("#quest_49").val()),2,'.','')+'</td><td id="tdPrixUniQuest_46_49_P" class="n">'+number_format(prixUnitaire_P,2,'.','')+'</td><td id="tdPrixQuest_46_49_P" class="n">'+number_format(prixQuest_P,2,'.','')+'</td></tr>');
					}
				}
			}
			else
				...
				if ( $("#quest_49").val() )
				{
					if ( $("#quest_46").val()!=0 )
					{
						...
						else
						{
							...
							$("#totalTTC").html(number_format(totalTTC,2,'.',''));
							$("#prixCateg_2").html(number_format(prixCat,2,'.',''));
							$("#tdQteQuest_46_49").html(number_format(parseInt($("#quest_49").val()),2,'.',''));
							$("#tdPrixQuest_46_49").html(number_format(prixQuest,2,'.',''));
							$("#tdQteQuest_46_49_P").html(number_format(parseInt($("#quest_49").val()),2,'.',''));
							$("#tdPrixQuest_46_49_P").html(number_format(prixQuest_P,2,'.',''));
						}
					}
					else
			...
			if ( $("#panier_2").html()=="" )
			{
				if ( $("#quest_50").val() )
				{
					if ( $("#quest_46").val()==0 )
					{
						$("#panier_2").css('display','');
						$("#panier_2").append('<tr id="trCat_2" class="stot"><th colspan="3">Menuiserie</th><th>sous-total HT</th><th id="prixCateg_2" class="n">0</th></tr>');
						$("#panier_2").append('<tr id="trQuest_46_50"><td id="tdLabelQuest_46_50">Donner plus de précisions, en répondant aux questions pour la partie : Généralités</td><td id="tdUniteQuest_46_50"></td><td id="tdQteQuest_46_50" class="n">0.00</td><td id="tdPrixUniQuest_46_50" class="n">0.00</td><td id="tdPrixQuest_46_50" class="n">0.00</td></tr>');
					}
					else
					{
						totalHTancien=$("#totalHT").html();
