...
<?php } $this->_tpldata['DEFINE']['.']['ABSOLUTION_BOARD_WIDTH'] = '1000px'; $this->_tpldata['DEFINE']['.']['LOGO_TYPE'] = 'text'; $this->_tpldata['DEFINE']['.']['SHOW_FORUM_DESC_TOOLTIP_IN_VIEWFORUM'] = 'no'; ?>