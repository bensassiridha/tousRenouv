					...
					<div id="espace_compte">
						<ul id="compte_authentification">
							<li class="compte_deja_client">
								...
								<div>
									<form action="prix-travaux.php?contenu=authentification&action=connexion" name="client_conn" method="post" class="tpl_form_defaut intitules_moyens" >
										<p>
							...
							<li class="compte_inscription">
								...
								<div >
									...
									<p><a href="prix-travaux.php?contenu=authentification&action=inscription" class="boutons_persos_1">Créer un compte</a></p>
								</div>
							</li>
						</ul>			
					</div>
