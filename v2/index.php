							...
							<div class="container">
								<div class="row">
									<div class="slider">
										...
										<p>recevez instantanément une offre détaillée et personnalisée</p>
										<button class="btn-slider"><a  href="prix-travaux.php" >Chiffrez vos travaux</a></button>
									</div>
								...
								<div class="row">
									<div class="particulier">
										<p>JE SUIS UN PARTICULIER</p>
											<div class="adv"><span>1</span><br /><h6><strong>Chiffrez</strong><br /> immédiatement et gratuitement vos travaux</h6></div>
											<div class="adv"><span>2</span><br /><h6><strong>Demandez</strong><br /> si vous  le souhaitez la visite d’un artisan partenaire</h6></div>
											<div class="btn-part"><a href="devis.php">Créer votre devis</a></div>
									</div>

									<div class="prof">
										<p>JE SUIS UN PROFESSIONNEL</p>
										<h6>Devtenez<br />Partenaire...</h6>
										<span>Vous n’êtes pas encore inscrit ?</span>
										<div class="btn-prof"><a href="espace_professionnel.php">Créer un compte</a></div>
									</div>
								</div>
							</div>
						</section>
						...
						<section id="whatwedo">
							<div class="container">
								<div class="row">
									...
									<div class="whatwedo">
										<h1>à qui s’adresse tousrenov ?</h1>
										<img src="images/services1.jpg">
										<p>TousRenov d’adresse à tous les particuliers qui souhaitent estimer rapidement leurs travaux de rénovation et/ou de consturction de leur habitat/maison individuelle</p>
									</div>

									<div class="whatwedo">
										<h1>types de travaux</h1>
										<img src="images/services2.jpg">
										<p>TousRenov permet de chiffrer tous les corps d’état : Maçonnerie, Sols, Murs, Cloisons, Doublage, Plafonds, Ouvretures, Plamberie, Sanitaire, Electricité, Chauffage...</p>
									</div>

									<div class="whatwedo">
										<h1>Trouver un artisan !</h1>
										<img src="images/services3.jpg">
										<p>TousRenov le met en contact avec un ou plusieurs artisans pour faire ses travaux de rénovation : Menuiseirie, Maçonnerie, électricité, Plomberie...</p>
									</div>
								</div>
							</div>
						</section>

						<section id="conseil-box">
							<div class="container">
								<div class="row">
									<div class="title">Actualités</div>
									<div class="actualite">
										<img src="images/actual1.jpg">
										<h1>TouRenov.fr</h1>
										<p>TousRenov d’adresse à tous les particuliers qui souhaitent estimer rapidement leurs travaux de rénovation et/ou de consturction de leur habitat/maison individuelle</p>
...
<script type="text/javascript">
	function validermail(formnewsletter)
	{
    	...
    	else
        {
			...
			<input class="button2" name="EnvoiNewsletter_desinscrit" type="submit" value="Désincription" />
			</form>
			</div>			
