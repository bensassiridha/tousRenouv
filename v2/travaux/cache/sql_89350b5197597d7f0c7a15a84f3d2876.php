<?php exit; ?>
1419510196
SELECT s.style_id, c.theme_id, c.theme_data, c.theme_path, c.theme_name, c.theme_mtime, i.*, t.template_path FROM phpbb_styles s, phpbb_styles_template t, phpbb_styles_theme c, phpbb_styles_imageset i WHERE s.style_id = 10 AND t.template_id = s.template_id AND c.theme_id = s.theme_id AND i.imageset_id = s.imageset_id
82847
a:1:{i:0;a:11:{s:8:"style_id";s:2:"10";s:8:"theme_id";s:2:"10";s:10:"theme_data";s:82433:"/*  phpBB 3.0 Style Sheet
    --------------------------------------------------------------
...
.site-desc {
	padding-left: 30px;	/* padding left has to be changed to 25px if there is no blank space on the left side of the site logo */
...
/* proFormell Control Panel Styles
---------------------------------------- */
...
#navigation a {
	...
	font-weight: bold;
	color: #333;
	background: #bababa none repeat-y 100% 0;
}
...
/* Below you can find fixes for IE6 and below */
* html .icon-members					{ background-image: url("{T_THEME_PATH}/images/icon_members.gif"); }
* html .icon-ucp						{ background-image: url("{T_THEME_PATH}/images/icon_ucp.gif"); }
* html .icon-register					{ background-image: url("{T_THEME_PATH}/images/icon_register.gif"); }
* html .icon-unsubscribe				{ background-image: url("{T_THEME_PATH}/images/icon_unsubscribe.gif"); }
* html .icon-search					{ background-image: url("{T_THEME_PATH}/images/icon_search.gif"); }

/* Fontsize */
* html a.fontsize { background-image: url("{T_THEME_PATH}/images/icon_fontsize.gif"); }

/* Button background */
* html a.button1, * html input.button1, * html input.button3, * html a.button2, * html input.button2 {
	background-image: url("{T_THEME_PATH}/images/bg_button.gif");
}

/* Print and email images */
* html a.print {
	background-image: url("{T_THEME_PATH}/images/icon_print_mail.gif");
}

* html a.sendemail {
	background-image: url("{T_THEME_PATH}/images/icon_print_mail.gif");
}";s:10:"theme_path";s:10:"proFormell";s:10:"theme_name";s:10:"proFormell";s:11:"theme_mtime";s:10:"1296688842";s:11:"imageset_id";s:2:"10";s:13:"imageset_name";s:10:"proFormell";s:18:"imageset_copyright";s:32:"&copy; Marc Alexander, 2007-2010";s:13:"imageset_path";s:10:"proFormell";s:13:"template_path";s:10:"proFormell";}}