...
$lang = array_merge($lang, array(
	...
	'ADMIN_PASSWORD_EXPLAIN'			=> '(Escolha uma Senha que tenha entre 6 e 30 carateres).',
	'ADMIN_TEST'						=> 'Verificar as configurações administrativas',
	'ADMIN_USERNAME'					=> 'Nome de Utilizador do Administrador',
	'ADMIN_USERNAME_EXPLAIN'			=> 'Escolha um nome de Utilizador que tenha de 3 a 20 carateres).',
	...
	'CONV_OPTIONS_BODY'					=> 'Esta página precisa do acesso ao código do Fórum. Introduza os dados da Base de Dados; o convertor não irá mexer no código atual. O acesso ao código deve ser desativado para evitar erros.',
	...
	'DB_HOST_EXPLAIN'					=> 'DSN significa Data Source Name e somente é relevante para instalações ODBC. No PostgreSQL, use localhost para conectar ao servidor local através do domínio socket UNIX e 127.0.0.1 para conectar atráves do TCP. Para SQLite, insira o caminho completo para o ficheiro da sua Base de Dados.',
	...
	'DLL_MBSTRING'						=> 'Suporte a carateres Multi-byte',
	...
	'INITIAL_CONFIG_EXPLAIN'			=> 'Agora que a instalação determinou que o servidor pode executar o phpBB são necessárias algumas informações específicas. Caso não saiba como ligar à sua Base de Dados, por favor, contate o seu serviço de hospedagem (em primeiro lugar) ou utilize o Fórum de suporte da <a href="http://www.phpbb.com/support/forums/">Comunidade phpBB.com</a> ou o <a href="http://www.suportephpbb.org/">Suporte Brasileiro phpBB</a>. Antes de continuar certifique-se que os dados inseridos estão corretos.',
	...
	'INST_ERR_PASSWORD_TOO_LONG'		=> 'A senha inserida é muito grande. O tamanho máximo é de 30 carateres.',
	'INST_ERR_PASSWORD_TOO_SHORT'		=> 'A senha inserida é muito pequena. O tamanho mínimo é de 6 carateres.',
	'INST_ERR_PREFIX'					=> 'Já existem tabelas com o prefixo indicado. Por favor, escolha outro prefixo.',
	'INST_ERR_PREFIX_INVALID'			=> 'O prefixo indicado é inválido para a sua Base de Dados. Tente outro. Eemova carateres, como por exemplo o hífen.',
	'INST_ERR_PREFIX_TOO_LONG'			=> 'O prefixo indicado é muito comprido. O comprimento máximo é %d carateres.',
	'INST_ERR_USER_TOO_LONG'			=> 'O nome de Utilizador indicado é muito comprido. O comprimento máximo é 20 carateres.',
	'INST_ERR_USER_TOO_SHORT'			=> 'O nome de Utilizador indicado é muito curto. O comprimento mínimo é 3 carateres.',
	...
	'MBSTRING_ENCODING_TRANSLATION'		=> 'Codificação de carateres transparentes',
	'MBSTRING_ENCODING_TRANSLATION_EXPLAIN'	=> '<var>mbstring.encoding_translation</var> deve ser 0.',
	'MBSTRING_HTTP_INPUT'				=> 'Conversão de carateres de entrada HTTP',
	'MBSTRING_HTTP_INPUT_EXPLAIN'		=> '<var>mbstring.http_input</var> deve ser <samp>pass</samp>.',
	'MBSTRING_HTTP_OUTPUT'				=> 'Conversão de carateres de saída HTTP',
	...
	'PHP_SUPPORTED_DB_EXPLAIN'			=> '<strong>Necessário</strong> - Deve ter pelo menos uma Base de Dados compatível com o phpBB. Se não há nenhuma Dase de Dados disponível, contate o seu fornecedor de Alojamento ou reveja a documentação do pphpBB relevante para obter ajuda.',
	...
	'REFRESH_PAGE_EXPLAIN'				=> 'Se clicar em "Sim", o conversor irá atualizar a página para continuar a conversão até à etapa final. Se esta é uma conversão apenas de teste e para determinaçãio de erros, clique em "Não".',
	...
	'STAGE_ADVANCED_EXPLAIN'			=> 'As configurações nesta página apenas são necessárias se desejar introduzir modificações à configuração padrão.<br /> Todas as configurações presentes nesta página podem ser efetuadas posteriormente no <strong>Painel de Administração</strong>.',
	'STAGE_CONFIG_FILE'					=> 'Ficheiro de Configuração',
	'STAGE_CREATE_TABLE'				=> 'Criação das Tabelas',
	'STAGE_CREATE_TABLE_EXPLAIN'		=> 'As Tabelas da Base de Dados utilizadas pelo phpBB 3x foram criadas com sucesso e atualizadas com as informações iniciais.<br /><br /> Continue para o próximo passo para concluir a instalação do phpBB.',
...
$lang = array_merge($lang, array(
	...
	'DOWNLOAD_CONFLICTS_EXPLAIN'		=> 'Procurar &lt;&lt;&lt; to spot conflits',	
	'DOWNLOAD_UPDATE_METHOD'			=> 'Transferir os Ficheiros modificados',
	'DOWNLOAD_UPDATE_METHOD_EXPLAIN'	=> 'Depois de transferir os Ficheiros deve descompatá-los e enviá-los para a diretoria raiz do seu phpBB. Envie os Ficheiros para os seus respetivos locais. Depois de enviar todos os Ficheiros, confira-os novamente clicando no botão abaixo.',
	...
	'FILES_MODIFIED_EXPLAIN'			=> 'Os ficheiros seguintes apresentam alterações relativamente à versão anterior. O novo ficheiro atualizado, resultará da fusão das modificações com o atual ficheiro.',
	...
	'FILES_NEW_CONFLICT_EXPLAIN'		=> 'Os ficheiros seguintes são novos na nova versão do phpBB, mas já existe um ficheiro com o mesmo nome na mesma posição. O atual ficheiro será substituído pelo novo.',
	...
	'INLINE_UPDATE_SUCCESSFUL'			=> 'A Base de Dados foi atualizada com sucesso. Pode continuar com o processo de atualização.',
	...
	'NO_UPDATE_FILES_OUTDATED'			=> 'Nenhuma diretoria de atualização válida foi encontrada, por favor, certifique-se de ter enviado corretamente os Ficheiros.<br /><br />A sua Instalação <strong>não</strong> está pronta. As atualizações estão disponíveis para a sua Versão do phpBB %1$s, por favor visite <a href="http://www.phpbb.com/downloads.php" rel="external">http://www.phpbb.com/downloads.php</a> para descarregar o pacote correto para atualizar da Versão %2$s para a Versão %3$s.',
	...
	'PERFORM_DATABASE_UPDATE_EXPLAIN'	=> 'Clique no botão para correr a actualização da Base de Dados. Este script tem que ser executado separadamente porque a atualização da Base de Dados pode ter um comportamente inesperado. A atualização da Base de Dados pode demorar alguns minutos, por favor não pare a execução da mesma. Depois de finalizada a atualização da Base de Dados, feche a janela e continue o processo de atualização.',
	...
	'UPDATE_DATABASE_SCHEMA'			=> 'Atualização do esquema da Base de Dados',
	...
	'UPDATE_INSTRUCTIONS'				=> ' 
		...
		<ul style="margin-left: 20px; font-size: 1.1em;"> 
			<li>Vá à <a href="http://www.phpbb.com/downloads.php" title="http://www.phpbb.com/downloads.php">Página de Transferências do phpBB.Com</a> e descarregue o "Pacote de Atualização do phpBB" correto.<br /><br /></li> 
	...
	'UPDATE_SUCCESS_EXPLAIN'			=> 'Todos os Ficheiros foram atualizados com sucesso. A próxima etapa envolve checar todos os Ficheiros novamente para ter certeza de que os Ficheiros foram atualizados corretamente.',
