...
$lang = array_merge($lang, array( 
	...
	'ACCOUNT_EMAIL_CHANGED'				=> 'A sua conta foi atualizada. <br />Neste Fórum as alterações de email requerem a reativação. <br />A chave de ativação foi enviada para o seu novo endereço de email. <br />Para mais detalhes verifique seu o email.',
	'ACCOUNT_EMAIL_CHANGED_ADMIN'		=> 'A sua conta foi atualizada. <br />Neste Fórum as alterações de email requerem a reativação por um administrador. <br />Receberá um email quando a sua conta for reativada.',
	'ACCOUNT_INACTIVE'					=> 'A sua conta foi criada com sucesso. <br />A Chave de Ativação foi enviada para o endereço de email que indicou durante o seu Registo. <br />Ao receber o email proceda à Ativação da sua conta. Só então poderá entrar no Fórum.',
	'ACCOUNT_INACTIVE_ADMIN'			=> 'A sua conta foi criada. <br />Neste Fórum a ativação da conta é feita pelo Administrador. Foi enviado um email ao Administrador que o informará quando Ativar sua conta. <br />Mantenha-se atento ao seu email.',
	...
	'BOOKMARKS'							=> 'Favoritos',
	'BOOKMARKS_EXPLAIN'					=> 'Esta é a sua lista de Favoritos. <br >Para remover da lista um Favorito, selecione a caixa correspondente e carregue no botão <b>Apagar Favoritos Marcados</b>.',
	...
	'FIELD_TOO_SHORT'					=> 'O Campo "%1$s" é muito curto. O mínimo de carateres é de %2$d.',
	'FIELD_TOO_LONG'					=> 'O Campo "%1$s" é muito longo. O máximo de carateres permitidos são %2$d.',
	...
	'FIELD_INVALID_CHARS_NUMBERS_ONLY'	=> 'O Campo "% s" tem carateres inválidos. São permitidos somente números.',
	'FIELD_INVALID_CHARS_ALPHA_ONLY'	=> 'O Campo "% s" tem carateres inválidos. São permitidos somente carateres alfanuméricos.',
	'FIELD_INVALID_CHARS_SPACERS_ONLY'	=> 'O Campo "% s" tem carateres inválidos. Somente alfanumérico, espaço ou - +_ [] são permitidos.',
	...
	'INVALID_CHARS_USERNAME'			=> 'O Nome de utilizador contém carateres proibidos.',
	'INVALID_CHARS_NEW_PASSWORD'		=> 'A Senha não tem os carateres exigidos.',
	...
	'PASS_TYPE_ALPHA_EXPLAIN'			=> 'Deve ter entre %1$d e %2$d carateres alfanuméricos.',
	'PASS_TYPE_ANY_EXPLAIN'				=> 'Deve ter entre %1$d e %2$d carateres.',
	'PASS_TYPE_CASE_EXPLAIN'			=> 'Deve ter entre %1$d e %2$d carateres e deve conter casos misturados.',
	'PASS_TYPE_SYMBOL_EXPLAIN'			=> 'Deve ter entre %1$d e %2$d carateres e deve conter símbolos.',
	'PASSWORD'							=> 'Senha',
	...
	'SIGNATURE_EXPLAIN'					=> 'Escreva aqui a Assinatura que por defeito será adicionada a todas a Mensagens. O limite é de %d carateres.',
	...
	'UCP_EMAIL_ACTIVATE'				=> 'Tem que usar um email válido.<br /> Após o Registo receberá um email para Ativação da sua conta.<br /> Só depois de receber esse email e Ativar a Conta é que poderá entrar no Fórum.',
	...
	'UCP_WELCOME'						=> 'Bem vindo ao Painel de Controlo do Utilizador.<br /> Aqui pode ver e atualizar o seu Perfil, as suas Preferências, observar Fóruns e Tópicos.<br /> Pode enviar Mensagens a outros <b>Utilizadores</b> (<i>se permitido</i>). Verifique se leu todos os anúncios.',
	...
	'USERNAME_ALPHA_ONLY_EXPLAIN'		=> 'O Nome de Utilizador deve ser constituído por %1$d a %2$d carateres e usar somente carateres alfanuméricos.',
	'USERNAME_ALPHA_SPACERS_EXPLAIN'	=> 'O Nome de Utilizador ddeve ser constituído por %1$d a %2$d carateres e usar carateres alfanuméricos, espaço ou -+_[].',
	'USERNAME_ASCII_EXPLAIN'			=> 'O Nome de Utilizador deve ser constituído por %1$d a %2$d carateres e deve conter somente carateres ASCII, sendo assim, sem símbolos especiais.',
	'USERNAME_LETTER_NUM_EXPLAIN'		=> 'O Nome de Utilizador deve ser constituído por %1$d a %2$d carateres e deve conter somente letras ou números.',
	'USERNAME_LETTER_NUM_SPACERS_EXPLAIN'	=> 'O Nome de utilizador deve ser constituído por %1$d a %2$d carateres e deve conter letras, números, espaço ou +-[].',
	'USERNAME_CHARS_ANY_EXPLAIN'		=> 'O Nome de Utilizador deve ser constituído por %1$d a %2$d carateres.',
