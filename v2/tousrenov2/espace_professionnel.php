	...
	switch ( $_GET['contenu'] )
	{
		case 'inscription' :
			...
			echo'
				...
				<div id="espace_compte" style="margin: 0 0 0 100px;">
					<form name="client_ajout" action="espace_professionnel.php?contenu=inscription" method="post" enctype="multipart/form-data" class="tpl_form_defaut intitules_moyens champs_larges">
					<fieldset>
		...
		case 'modif_param' :
			...
			echo'
				'.$alert.'
				<div id="espace_compte" style="margin: 0 0 0 100px;">
					<form name="client_modif" action="espace_professionnel.php?contenu=modif_param" method="post" enctype="multipart/form-data" class="tpl_form_defaut intitules_moyens champs_larges">
					<fieldset>
						<legend>Informations personnelles</legend>
						<p>
							<label for="ip_fo">Forme juridique : </label>
							<input id="ip_fo" type="text" name="juridique" value="'.$cl['juridique'].'"/>
						</p>
						<p>
							<label for="ip_ra">Raison sociale : </label>
							<input id="ip_ra" type="text" name="raison" value="'.$cl['raison'].'"/>
						</p>
						<p>
							<label for="ip_ta">Taille de l\'entreprise : </label>
							<input id="ip_ta" type="text" name="taille" value="'.$cl['taille'].'"/>
						</p>
						<p>
							<label for="ip_voi">Numéro et voie : <span class="obli">*</span></label>
						...
						<p>
							<label for="ip_ca">Complèment d\'adresse : </label>
							<input id="ip_ca" type="text" name="cadresse" value="'.$cl['cadresse'].'"/>
						</p>
						<p>
							<label for="ip_cp">Code postal : <span class="obli">*</span></label>
							<input id="ip_cp" type="text" name="cp" onKeyPress="return scanTouche(event)" value="'.$cl['code_postal'].'"/>
						</p>
						<p>
							<label for="ip_ville">Ville : <span class="obli">*</span></label>
		...
		case 'devis_encours' :
			if ( isset($_GET['idDevis']) )
			{
				...
				$detail.='
					...
					'.$alert.'
					<form name="prix_enchere" method="post" action="espace_professionnel.php?contenu=devis_encours&idDevis='.$_GET['idDevis'].'" class="tpl_form_defaut intitules_moyens champs_larges" >
						<fieldset>
							<legend>Prix : </legend>
							'.$texte.'
							<p>
								<label for="ip_mail">Prix ( Entre '.$prix_min.' et '.$prix_max.' ) :<span class="obli">*</span></label>
								<input style="margin:0;" id="ip_mail" type="text" name="prix" onKeyPress="return scanTouche(event)"/>
							</p>
							<p class="align_center padding_tb_20">
					...
					<p class="margin_top_20"><a href="espace_professionnel.php?contenu=devis_encours">Retour à la page précédente</a></p>
						';
				echo'
					<div id="espace_compte">
						'.$detail.'
		...
		case 'devis_histo' :
			if ( isset($_GET['idDevis']) )
			{
				...
				$detail.='
						...
						'.$alert.'
						<div id="espace_compte">
							<form  style="margin: 10px 0 0 120px;" name="message_envoie" method="post" class="tpl_form_defaut intitules_moyens champs_larges" enctype="multipart/form-data" >
								<fieldset>
									...
									<p>
										...
										<table style="text-align:center;margin:0 0 0 170px;" id="tblPhoto" >
											<tr>
...
else
{
	if ( !isset($_SESSION['id_client_trn_pro']) )
	{
		...
		echo'
			'.$alert.'
			<div id="espace_compte">
				<ul id="compte_authentification">
					<li class="compte_deja_client">
						<p class="titre"><strong>Vous avez déjà un compte ?</strong></p>
						<div>
							<form action="espace_professionnel.php?contenu=connexion" name="client_conn" method="post" class="tpl_form_defaut intitules_moyens" >
								<p>
									<label for="mail">Votre adresse mail :</label>
									<input id="mail" type="text" name="email_connexion" />
								</p>
								<p>
									<label for="mdp">Votre mot de passe :</label>
									<input id="mdp" type="password" name="mdp_connexion"/>
								</p>
								<p class="padding_top_5"><cite>Si vous avez oublié votre mot de passe, <a href="espace_professionnel.php?contenu=mdp_perdu" style="color:#000">cliquez ici</a>.</cite></p>																
								<p>
					...
					<li class="compte_inscription">
						<p class="titre"><strong>Vous êtes nouveau client ?</strong></p>
						<div >
							...
							<p><a href="espace_professionnel.php?contenu=inscription" class="boutons_persos_1">Créer un compte</a></p>
						</div>
					</li>
				</ul>			
			</div>
