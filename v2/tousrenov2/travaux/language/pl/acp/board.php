...
$lang = array_merge($lang, array(
	...
	'SYSTEM_TIMEZONE_EXPLAIN'			=> 'Strefa czasowa używana do wyświetlania czasów dla użytkowników niezalogowanych (gości i botów). Zalogowani użytkownicy mogą ustawić swoją strefę czasową podczas rejestracji oraz w panelu użytkownika.',
...
$lang = array_merge($lang, array(
	...
	'ACP_FEED_HTTP_AUTH_EXPLAIN'		=> 'Logowanie HTTP pozwala użytkownikom otrzymywać zawartość ukrytą przed gościami poprzez dodanie parametru <code>auth=http</code> do URL kanału. Niektóre serwery PHP wymagają dodatkowych zmian w pliku .htaccess. Instrukcje można znaleźć w tym pliku.',
...
// Zabezpieczenia przeciwbotowe
$lang = array_merge($lang, array(
	'ACP_VC_SETTINGS_EXPLAIN'				=> 'Tutaj możesz wybrać i skonfigurować wtyczki służące do blokowania automatycznego wysyłania formularzy przez boty spamujące. Wtyczki te zazwyczaj działają poprzez wymaganie od użytkownika podania rozwiązania testu, który ma być trudny dla komputerów a prosty dla ludzi.',
...
// Ciasteczka
$lang = array_merge($lang, array(
	'ACP_COOKIE_SETTINGS_EXPLAIN'		=> 'Tutaj możesz zmienić dane używane do wysyłania ciasteczek do przeglądarek użytkowników. W większości przypadków domyślne wartości powinny być odpowiednie. Jeśli musisz coś zmienić, rób to uważnie, ponieważ nieprawidłowe ustawienia mogą uniemożliwić logowanie użytkownikom. <strong style="color:red;">Domena ciasteczka powinna mieć formę <code>.adres-forum.pl</code>, bez przedrostka <code>www</code>!</strong>',
