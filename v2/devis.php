...
if ( isset($_GET['cat']) )
{
	...
	echo'
		...
		<div id="espace_compte" style="margin: 0 0 0 100px;">
			<form name="cat_ajout" action="devis.php?contenu=panier&action=ajouter" method="post" enctype="multipart/form-data" class="tpl_form_defaut intitules_moyens champs_larges">
				<fieldset>
					<legend>'.$temp['titre'].'</legend>
					<p>
						<label for="ip_mail">Description : <span class="obli">*</span></label>
						<textarea id="ip_mail" type="text" name="piece">'.$contenu.'</textarea>
					</p>
					...
					<div id="espace_compte">
						<ul id="compte_authentification">
							<li class="compte_deja_client">
								...
								<div>
									<form action="devis.php?contenu=authentification&action=connexion" name="client_conn" method="post" class="tpl_form_defaut intitules_moyens" >
										<p>
										...
										<p class="padding_top_5"><cite>Si vous avez oublié votre mot de passe, <a href="espace_pro.php?contenu=mdp_perdu"style="color:#000">cliquez ici</a>.</cite></p>																
										<p>
							...
							<li class="compte_inscription">
								...
								<div >
									...
									<p><a href="devis.php?contenu=authentification&action=inscription" class="boutons_persos_1">Créer un compte</a></p>
								</div>
							</li>
						</ul>			
					</div>
