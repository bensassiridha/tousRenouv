<?php
	...
	class mysql
	{
		function mysql()
		{
		   ...
		   $this->connexion = mysql_connect("tousrenovcfr.mysql.db","tousrenovcfr","MAROC2015");
	...
	function net_input($arg)
		{
			...
			$this->arg_net = mysql_real_escape_string(htmlentities($radhouano, ENT_QUOTES, 'ISO-8859-1'));
			return $this->arg_net;
		}
