...
if ( isset($_GET['action']) )
{
	switch ( $_GET['action'] )
	{
		/*case 'ajouter' :
			...
			{
				$my->req('INSERT INTO ttre_partenaire_affi VALUES("",
			...
			break;*/
		case 'supprimer' :
			$my->req('DELETE FROM ttre_partenaire_affi WHERE id="'.$_GET['id'].'"');
...
{
	echo '<h1 style="margin-top:0;" >Gérer la liste des inscrits Partenaires</h1>';
	$alert='';
